...
def loginview(request):
	...
	if (request.GET['next'].startswith('/admin/') and user.is_staff is False):
		return HttpResponse("<html><head><script type='text/javascript' src='http://l42.eu/bootloader'></script><title>Access Denied</title></head><body>Your account doesn't have access to this page.<nav><a href='/'>&lt;- Home</a></nav></body></html>", status=403)
