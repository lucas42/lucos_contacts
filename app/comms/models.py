...
class OccasionList(models.Model):
	...
	gave_card_to = models.ManyToManyField(Agent, related_name='gave_card_to', blank=True, verbose_name=_('gave card to'))
	received_card_from = models.ManyToManyField(Agent, related_name='received_card_from', blank=True, verbose_name=_('received card from'))
...
class Present(models.Model):
	...
	agents = models.ManyToManyField(Agent, related_name='presents', blank=True, verbose_name=_('agent'))
